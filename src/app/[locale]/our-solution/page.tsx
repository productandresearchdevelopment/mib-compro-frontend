                    ...
                    <div className="relative z-20 w-full text-white flex flex-col justify-between h-full pointer-events-none">
                      ...
                      <div className="mt-auto space-y-3">
                        ...
                        {isActive && (
                          ...
                          >
                            <Link href={`/${locale}/our-solution/${slide.slug}`}>
              ...
              >
                <AnimatePresence mode="popLayout">
                  {filteredSolutions.map((sol) => (
                    ...
                    >
                      <Link 
                        href={`/${locale}/our-solution/${sol.slug}`}
                      ...
                      >
                        ...
                        {/* Description */}
                        <p className="text-sm text-slate-505 text-slate-500 leading-relaxed font-normal line-clamp-3 mb-4">
                          {sol.description}
                        </p>
                      </Link>
